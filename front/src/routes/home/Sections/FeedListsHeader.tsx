...
export default function FeedListHeader() {
    return <>
        <NewPostAction />
        <div className="bg-white mt-4 rounded-lg overflow-hidden relative flex border-l-4 -tracking-wide border-l-green-500 flex-col items-start justify-start p-3  gap-0">
